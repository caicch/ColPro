...
def get_args_parser():
    ...
    parser.add_argument('--adapter_len', type=int, default=15, metavar='LENGTH', help='the adapter length')
    parser.add_argument('--max_seq_len', type=int, default=280, metavar='LENGTH', help='the maximum sequence length')
    parser.add_argument('--max_feats', type=int, default=10, metavar='LENGTH', help='the maximum feature length')

    # Optimizer parameters
    parser.add_argument('--weight_decay', type=float, default=0.10, help='weight decay (default: 0.05)')
    ...
    # Dataset parameters
    parser.add_argument('--dataset', default='dramaqa', type=str, help='dataset')
    parser.add_argument('--output_dir', default='./checkpoint/dramaqa', help='path where to save, empty for no saving')
...
def main(args):
    ...
    #DL - where, DO - Who, TW - what, CW - why, CH- How
    qn_types = ['DL', 'CW', 'TW', 'DO', 'CH'] #'TW', 'DO', 'DL', 'CH', 'CW' #'DL', 'CW', 'TW', 'DO', 'CH' #'CW', 'CH', 'DO', 'TW', 'DL'
    processed_type = []
